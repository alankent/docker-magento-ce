...
RUN apt-get install -y --force-yes apache2 libapache2-mod-php5 php5-mysql php5-xdebug php5-curl php5-gd php5-mcrypt curl
...
RUN mkdir /magento
ADD composer.json /magento/composer.json
RUN cd /magento && curl -sS https://getcomposer.org/installer | php
